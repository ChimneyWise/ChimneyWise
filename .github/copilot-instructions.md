# Copilot Instructions for ChimneyWise

## Project Overview
- This is a .NET solution for ChimneyWise, using Clean Architecture principles.
...
- The solution is managed via `ChimneyWise.slnx` and `global.json`.
...
## Developer Workflows
- **Build**: Run `dotnet build ChimneyWise.slnx` from the repo root.
- **Test**: Run `dotnet test ChimneyWise.slnx` to execute all tests.
